const azureFunctionsDevelopment = {
    ...
    GetStatistics: "http://localhost:7071/api/GetStatistics",
    ...
    PushStatistic: "http://localhost:7071/api/PushStatistic",
...
const azureFunctionsProduction = {
    ...
    GetStatistics: "https://jebrafunctions.azurewebsites.net/api/GetStatistics?code=r2L40fKpaMX8eHelwY4GivC9OOYi4Xd18AHvj4mhu1JBXqiT8WuDHg==",
    ...
    PushStatistic: "https://jebrafunctions.azurewebsites.net/api/PushStatistic?code=wPL96Bo7YfxJRrN77oEIDJu2/HndQaYseDmQN91s6KbZUEFiKujRig==",
